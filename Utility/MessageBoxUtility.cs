...
namespace EWPF.Utility
{
    ...
    public static class MessageBoxUtility
    {
        ...
        public static MessageBoxResult ShowMessageBox(string i_Caption, string i_Content, MessageBoxButton i_Button,
            MessageBoxImage i_Image, MessageBoxOptions i_Options)
        {
            switch (i_Button)
            {
                case MessageBoxButton.OK:
                    return ShowOkDialog(i_Caption, i_Content, i_Image, i_Options);
